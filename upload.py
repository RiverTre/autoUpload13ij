...
#打开EXCEL
data = xlrd.open_workbook('C:\\Users\\Administrator\\Desktop\\file1.xls')
table = data.sheets()[0]
...
driver.find_element_by_id("mobile").send_keys("11111111111111111")
driver.find_element_by_id("password").click()
driver.find_element_by_id("password").clear()
driver.find_element_by_id("password").send_keys("111111111111")
...
for i in range(nrows):  # nrows为边界，不包括nrows
    ...
    try:
        ...
        i = i-1
        continue
    # 本来想每上传一条删除一条，但是删除后可能会影响i的大小，暂时不管    //table.Rows(i)
